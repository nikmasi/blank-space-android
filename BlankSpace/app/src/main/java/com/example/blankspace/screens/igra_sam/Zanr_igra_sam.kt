...
fun Zanr_igra_sam(navController: NavController,selectedNivo:String,viewModelIgraSam:IgraSamViewModel){
    Box(modifier = Modifier.fillMaxSize().padding(top=52.dp)) {
        ...
        Zanr_igra_sam_mainCard(navController,selectedNivo,viewModelIgraSam)
    }
}

@Composable
fun Zanr_igra_sam_mainCard(navController: NavController,selectedNivo: String,viewModelIgraSam:IgraSamViewModel) {
            ...
            SmallButton(
                onClick = {
                    if (selectedZanrovi.isNotEmpty()) {
                        ...
                        navController.navigate(Destinacije.Igra_sam.ruta + "/$zanroviIds/$selectedNivoList/0/0")
                    } else {
