...
fun Nivo_challenge(navController: NavController){
    Box(modifier = Modifier.fillMaxSize().padding(top=52.dp)) {
        ...
        Nivo_challenge_mainCard(navController)
    }
}

@Composable
fun Nivo_challenge_mainCard(navController: NavController) {
    Surface(
        color = Color.White,
        ...
        Column(
            ...
            NivoChallengeButtons(navController)
        }
    }
}

@Composable
fun NivoChallengeButtons(navController: NavController) {
    SmallButton(
        onClick = {
