...
@Composable
fun Kraj_pogodiPevaj(poeni:Int,viewModelLogin: LoginViewModel,igraSamViewModel: IgraSamViewModel,onClickPonovo: () ->Unit, onClickKraj: () ->Unit){
    Box(modifier = Modifier.fillMaxSize().padding(top=52.dp)) {
        BgCard2()
        val poeni2 = poeni/10
        Kraj_pogodiPevaj_mainCardStyled(poeni2,viewModelLogin,igraSamViewModel,
