...
fun Kraj_challenge(navController: NavController,poeni:Int,viewModelLogin: LoginViewModel,igraSamViewModel: IgraSamViewModel){
    Box(modifier = Modifier.fillMaxSize().padding(top=52.dp)) {
        ...
        val poeni2=poeni/10
        Kraj_challenge_mainCard(navController,poeni2,viewModelLogin,igraSamViewModel)
    }
}

@Composable
fun Kraj_challenge_mainCard(navController: NavController,poeni: Int,viewModelLogin: LoginViewModel,igraSamViewModel: IgraSamViewModel) {
...
fun KrajIgreButtons(navController: NavController) {
    SmallButton(
        onClick = {
            navController.navigate(Destinacije.Nivo_challenge.ruta)
        },
        text = "Igraj ponovo",
